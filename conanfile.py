...
class ChartLegendViewPluginConan(ConanFile):
    ...
    name = "ChartLegendViewPlugin"
    description = ("A plugin for data heat-maps in ManiVault.")
    topics = ("hdps", "ManiVault", "plugin", "ChartLegendViewPlugin", "data visualization")
    url = "https://github.com/ManiVaultStudio/ChartLegendViewPlugin"
    ...
    scm = {
        "type": "git",
        "subfolder": "hdps/ChartLegendViewPlugin",
        "url": "auto",
        "revision": "auto",
    }
    ...
    def _configure_cmake(self):
        cmake = CMake(self)
        cmake.configure(build_script_folder="hdps/ChartLegendViewPlugin")
        cmake.verbose = True
        return cmake
